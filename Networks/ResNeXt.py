...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, num_group=32):
        ...
        self.conv2 = nn.Conv2d(planes * 2, planes, kernel_size=3, stride=stride,
...
def ResNeXt18(num_classes, **kwargs):
    """Constructs a ResNeXt-18 model.
    """
    model = ResNeXt(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, **kwargs)
    return model


def ResNeXt34(num_classes, **kwargs):
    """Constructs a ResNeXt-34 model.
    """
    model = ResNeXt(BasicBlock, [3, 4, 6, 3], num_classes=num_classes, **kwargs)
    return model


def ResNeXt50(num_classes, **kwargs):
    """Constructs a ResNeXt-50 model.
    """
    model = ResNeXt(Bottleneck, [3, 4, 6, 3], num_classes=num_classes, **kwargs)
    return model


def ResNeXt101(num_classes, **kwargs):
    """Constructs a ResNeXt-101 model.
    """
    model = ResNeXt(Bottleneck, [3, 4, 23, 3], num_classes=num_classes, **kwargs)
    return model


def ResNeXt152(num_classes, **kwargs):
    """Constructs a ResNeXt-152 model.
    """
    model = ResNeXt(Bottleneck, [3, 8, 36, 3], num_classes=num_classes, **kwargs)
    return model

if __name__ == '__main__':
    model = ResNeXt152(num_classes=2)

...
class ResNet34_CBAM(nn.Module):
    def __init__(self, num_classes):
        ...
        self.base = _resnet('resnet34', BasicBlock, [3, 4, 6, 3], pretrained=True, progress=True)
...
class ResNet50_CBAM(nn.Module):
    def __init__(self, num_classes):
        ...
        self.base = _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained=True, progress=True)
        # self.base = nn.Sequential(*list(self.base.children())[:-1])
...
class ResNet101_CBAM(nn.Module):
    def __init__(self, num_classes):
        ...
        self.base = _resnet('resnet101', Bottleneck, [3, 4, 23, 3], pretrained=True, progress=True)
        # self.base = nn.Sequential(*list(self.base.children())[:-1])
